...
router.post('/', async (req, res) => {
  try {
    const { artist, song, genre, spotify, description, mood, target_audience, email } = req.body;
    ...
    const config = buildConfig({ artist, song, genre, spotify, description, mood, target_audience,
